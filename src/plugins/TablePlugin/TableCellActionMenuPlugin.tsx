  ...
  useEffect(() => {
    ...
    if (menuButtonDOM != null && tableCellNode != null) {
      ...
      if (tableCellNodeDOM != null) {
        ...
        menuButtonDOM.style.left = `${tableCellRect.right - menuRect.width - 10 - anchorRect.left}px`;
...
export function TableCellActionMenuPlugin({ anchorElem = document.body }: { anchorElem?: HTMLElement }): ReactPortal {
